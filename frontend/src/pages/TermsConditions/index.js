...
const TermsConditions = () => (
  ...
  >
    <p>
      This website (the "Site") is brought to you by Charibin, LLC. d/b/a Charibin (“Charibin”).
      Your use of the Site is governed by these terms of use. Please read these terms carefully
      and do not use this Site if you do not agree with these terms of use. The services provided
      on the Site include auctions and the Custom Experiences and Do Good Programs (collectively,
      the "Custom Experiences" Program) for a variety of property and experiences. By using this
      Site and participating in these auctions and the Custom Experiences Program, YOU AGREE TO
      BE BOUND TO ANY PURCHASES YOU WIN AND YOU FURTHER AGREE TO BE BOUND BY THESE TERMS OF USE.
    </p>
    ...
    <p>
      ...
      tangible property, including without limitation artwork, apparel, food, wine, sports and music
    ...
    <p>
      ...
      governmental authorities within or outside your country of residence − for Charibin to disclose
