...
export default [
  {
    "question": "How do I join Charibin?",
    "answer": <div>
      Registering is easy. To begin, just click the <IconUser className="text-primary" /> icon on the upper right hand corner of your screen. Add your contact info and create a username and password, or connect to Charibin through your Facebook account. This username will be publicly displayed any time you place a bid. Next, add payment and billing information to your account. (Don't worry, you won't be charged unless you win an auction!) Lastly, provide us with your shipping address. When you're finished, you can place bids, track auction lots, and modify your account settings.
    </div>,
  },
  {
  ...
  },
  {
    ...
    "answer": "There is no cost to become a Charibin bidder. Your credit card will only be charged if you win an auction lot.",
  },
  {
    "question": "Why do I have a $1 pending charge from Charibin on my statement or account?",
    "answer": "This is for credit card validation purposes. The $1 was an authorization and should fall off your account within 72 hours. This $1 authorization does not imply that a purchase from Charibin has been made or attempted, and there are no further pending charges as a result of our validation.",
  },
  {
