...
const PrivacyPolicy = () => (
  ...
  >
    <Section className="page-content">
      ...
      <p>
        Your privacy is extremely important to Charibin. We have developed a Privacy Policy
        ...
        <a href="mailto:privacy@charibin.com">privacy@charibin.com</a>
      </p>
      <h4>Disclosure to Third Parties</h4>
      <p>
        At times Charibin may make certain personal information available to strategic partners
        that work with Charibin to provide products and services, or that help Charibin market to
        customers. Charibin shares personal information with companies who provide services such
        ...
        may be located wherever Charibin operates. We will share your personal information with
      ...
      <p>
        ...
        and governmental authorities within or outside your country of residence − for Charibin
